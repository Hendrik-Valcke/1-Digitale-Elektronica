...
entity bcdTo7segTestbench is --er zijn niet echt poorten bij de testbench dus dit stuk is leeg (denk ik)
end bcdTo7segTestbench;

architecture Behavioral of bcdTo7segTestbench is 
--signalen definieren die voor controle zullen worden gebruikt
...
begin
  ...
  BcdTo7Seg1DigitaleDesign: BcdTo7Seg1Digitale port map( --bcd van design wordt inputvector in testbench enz..
    bcd => InputVector,
  ...
  begin
        ...
        wait for 90ns; -- dus iedere 100ns een nieuw signaal
